...
public class CreatePlant : MonoBehaviour {
    ...
    public static int maxSideBudsPerNode = 3;
    public int randomSeed = 55;
    public int growthCycles = 8;
    public static float growthLength = 6f;
    public static float dieProbability = 0.02f;
    public static float pauseProbability = 0.1f;

    public Text seedText;

    private Vector3 rotateAngle = new Vector3(0f, 0.5f, 0f);

    // GameObjects
    private GameObject plant_autumn;
    private GameObject plant_green;
    private GameObject plant_sakura;
    ...
    void Start () {
        ...
        // Set Seed Text
        seedText.text = "Seed: " + randomSeed;

        plant_autumn = generatePlant("Autumn");
        plant_autumn.name = "Autumn";
        plant_autumn.transform.position = new Vector3(0f, 0f, 0f);

        plant_green = generatePlant("Green");
        plant_autumn.name = "Green";
        plant_green.transform.position = new Vector3(-50f, 0f, 0f);

        plant_sakura = generatePlant("Sakura");
        plant_autumn.name = "Sakura";
        plant_sakura.transform.position = new Vector3(50f, 0f, 0f);

    }
	
	// Update is called once per frame
	void Update () {
        plant_autumn.transform.Rotate(rotateAngle);
        plant_green.transform.Rotate(rotateAngle);
        plant_sakura.transform.Rotate(rotateAngle);
    }
    ...
    public class Bud {
        ...
        public Bud(Vector3 pos, Vector3 dir, int age, int order) {
            this.pos = pos;
            this.direction = dir;
            this.die_prob = dieProbability;
            this.pause_prob = pauseProbability;
            this.age = age;
            this.order = order;
            this.isDead = false;
        }
